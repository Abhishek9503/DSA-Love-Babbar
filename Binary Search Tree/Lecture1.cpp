...
// // Node *inertIntoBST(Node *root, int data)
// // {
// //     if (root == NULL)
// //     {
// //         root = new Node(data);
...
// //     if (root->data > data)
// //     {
// //         root->left = inertIntoBST(root->left, data);
// //     }
// //     else
// //     {
// //         root->left = inertIntoBST(root->left, data);
...
// //     cout << "Enter the for Node" << endl;

// //     takeInput(root);

// //     cout << "Priniting the tree" << endl;
